...
export class DischargePatientMedicineComponent implements OnInit {
  ...
  this.othermedicHome=localStorage.getItem('otherMedicsHome');
  console.log(' this.othermedicHome====',this.othermedicHome);
...
//==========================
addmoreOtherMedics(){
this.otherMedicsHome.push(this.treatmentForm.value.tComments);
this.treatmentForm.reset();
console.log('other medics array-------',this.otherMedicsHome)
}
//=============================
removeArr2(indx){
  this.otherMedicsHome.splice(indx, 1);
  console.log('$x2==',this.otherMedicsHome)
}
//===============================
//==========================
changeCheckboxVal(e) {
