...
export class PrintReportComponent implements OnInit {
  ...
  //pathology modal
  openModalWithClassPathology(template2: TemplateRef<any>,data) {
...
getUsersPending() {
  ...
  this.model.tokenID=this.pathData1.ptID;
  ...
  this.wardService.getindoordetails(this.model).subscribe(
    (response: any) => {
      if (response.status === 0) {
        ...
        // });
        this.PathResponseArray=response.testData;
