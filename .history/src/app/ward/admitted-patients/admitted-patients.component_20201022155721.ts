...
operateIndoor(opeData) {
  console.log('indoorData',opeData)
  this.loaderUpdate= true;
  ...
  this.model9.departmentID=this.hospitalID;
  
 
  this.model9.indoorStatus=1;
  this.model9.isCriticalIll=opeData.criti_ill;

  this.model9.operativeProcedure=opeData.operate_procedure;
  this.model9.dialysis=opeData.dylasis;
  this.model9.dischargeType='';
  this.model9.dischargeDate='';
