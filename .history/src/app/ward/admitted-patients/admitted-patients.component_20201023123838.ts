...
sendTolab() {
  ...
  this.model11.medicines=this.medicinesFinal;
  this.model11.type=2;
...
onSelectPathology(path){
  ...
  // });
  this.localPath.push({"id":-1,"result":"","patientID":this.detailsData.patientID,"testName":path.item.testName,"testID":path.item.testID,"testType":path.item.testType,"refRange":path.item.refRange,"isSupper":path.item.isSupper})
