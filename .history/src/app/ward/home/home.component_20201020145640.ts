...
//get all diagnostic list
admitPatient(patObj) {
  console.log('modal data in function======',this.userDataRow)
  this.loader_eqp = true;

  this.model6.bedNo=patObj.female;
  this.model6.isMLC=patObj.male;
  this.model6.token=patObj.male;
  this.model6.patientID=patObj.total;
