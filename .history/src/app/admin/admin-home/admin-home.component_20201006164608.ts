...
// }
  ...
  showEditData(edtObj){
    ...
    this.EuserOb.Edes=edtObj.name;
    this.EuserOb.Ejoining=edtObj.name;
    this.EuserOb.Econtact=edtObj.name;
    this.EuserOb.Euname=edtObj.name;
    this.EuserOb.Epassword=edtObj.name;
  }
