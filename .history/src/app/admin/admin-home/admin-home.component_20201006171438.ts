...
// }
  ...
  //add new user
   ...
   updateUser() {
    ...
    this.model2.designation =  this.EuserOb.id;
    this.model2.joiningDate =  this.EuserOb.id;
    this.model2.contact =  this.EuserOb.id;
    this.model2.username =  this.EuserOb.id;
    this.model2.password =  this.EuserOb.id;
