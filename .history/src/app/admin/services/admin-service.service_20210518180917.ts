...
export class AdminServiceService {
  ...
  get_mhpss_session_photos(obj: any) {
    let url = APP_CONFIG.apiBaseUrl + 'get_mhpss_session_photos';
    return this.http.post(url, obj);
  }
  upload_to_s3(obj: any) {
    let url = APP_CONFIG.apiBaseUrlS3 + 'uploadfile';
    return this.http.post(url, obj);
  }
  get_mhpss_sessions_by_village(obj: any) {
    let url = APP_CONFIG.apiBaseUrl + 'get_mhpss_sessions_by_village';
    return this.http.post(url, obj);
  }
  get_mhpss_sessions_by_user(obj: any) {
    let url = APP_CONFIG.apiBaseUrl + 'get_mhpss_sessions_by_user';
    return this.http.post(url, obj);
  }
  
  mhpss_villages(obj: any) {
    let url = APP_CONFIG.apiBaseUrl + 'mhpss_villages';
    return this.http.post(url, obj);
  }
  add_mhpss_session(obj: any) {
    let url = APP_CONFIG.apiBaseUrl + 'add_mhpss_session';
    return this.http.post(url, obj);
  }
  ///////////mphssss
  getPatList(obj: any) {
