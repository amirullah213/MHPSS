...
@NgModule({
  ...
  imports: [
    OperationRoutingModule, ReactiveFormsModule, CommonModule, SharedModule, DataTablesModule, ModalModule.forRoot(), FormsModule, BsDatepickerModule.forRoot(), CollapseModule.forRoot(),TypeaheadModule.forRoot(),
