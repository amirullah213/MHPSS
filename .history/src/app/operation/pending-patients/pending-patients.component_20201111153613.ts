...
updateOperationData(fromData) {
  ...
  this.model.hospitalID=this.hospitalID;
  this.model.tokenID=this.otDetails.ptID;
  this.model.anesthesiaType=fromData.anesthesiaType;
  this.model.anethetistName=fromData.anethetistName;
  this.model.surgeonName=fromData.surgeonName;
  this.model.anethetistName=fromData.anethetistName;
  this.model.remarks=fromData.remarks;
