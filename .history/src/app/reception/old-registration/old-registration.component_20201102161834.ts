  ...
  this.receptService.generToken(this.model3).subscribe(
   (response: any) => {
     if (response.status === 0) {
        ...
        this.ttvResponseArray=response.data;
  ...
  this.receptService.generToken(this.model3).subscribe(
   (response: any) => {
     if (response.status === 0) {
        ...
        this.childResponseArray=response.data;
        console.log('hospitl childResponseArray==',this.childResponseArray);
        this.loaderChild = false;
        alert('TT vacination token generated successfuly');
        localStorage.setItem('paDtokenDetailsetails',JSON.stringify(this.childResponseArray.patient));
