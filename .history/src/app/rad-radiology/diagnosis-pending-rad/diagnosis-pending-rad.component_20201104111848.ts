...
//--------------------------------
 ...
 updateSingleTest(diagnos) {
   ...
   console.log('this.AddArray==',this.AddArray);
   this.singleobj.xrayFilms6=JSON.stringify(this.AddArray) ;
   this.singleobj.result=JSON.stringify(this.AddArray) ;
   console.log('this.singleobj==',diagnos);
