...
saveData(dat){
  ...
  // calculate age
  compareValues(indx){
    console.log("cpmpare called");
    console.log("cpmpare called",this.purchaseOrder.value[indx].issuedQuantity);
    console.log("cpmpare called",this.purchaseOrder.value[indx].prescribedQuantity);
    ...
    if(this.purchaseOrder.value[indx].issuedQuantity > this.purchaseOrder.value[indx].totalQuantity){
      alert('Issued quantity should not be greater than total quantity')
