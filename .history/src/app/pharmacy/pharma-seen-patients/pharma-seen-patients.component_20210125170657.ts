...
newArray3:any =[];
  ...
  constructor(private modalService: BsModalService, private fb: FormBuilder,
     private pharmacySer:PharmacyServicesService, private router:Router) {
...
gotoPrintPage(){
  console.log('print page data',this.printData);
  if(this.printData.isIndoor==0){
    localStorage.setItem('pharmacyData',JSON.stringify(this.printData) );
    window.open('/print/home')
  }else{
    localStorage.setItem('wardData',JSON.stringify(this.printData) );
