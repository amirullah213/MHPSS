...
const routes: Routes = [
  { 
    ...
    children: [
      ...
      { path: 'bincard-items', component: BincardItemsComponent },
      { path: 'bincard-smr', component: BincardSmrComponent },

      { path: 'pat_details', component: DetailsComponent },
      { path: 'print_prescription', component: PrintPrescriptionComponent },
      { path: 'smr-pat--details', component: PrintPrescriptionComponent },
