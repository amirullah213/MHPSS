...
saveData(dat){
  ...
  AssinIssueQuantity(quant,sid,ind){

    // console.log('resp from batch ind==',ind);
    // console.log('resp from batch quan==',quant);
    // console.log('resp from batch stockid==',sid);
   ...
   // this.dynamicForm.get('totalQuantity').setValue('123');
    this.dynamicForm['controls'].purchaseOrder['controls'][ind]['controls'].totalQuantity.patchValue(quant);
    this.dynamicForm['controls'].purchaseOrder['controls'][ind]['controls'].stockID.patchValue(sid);
