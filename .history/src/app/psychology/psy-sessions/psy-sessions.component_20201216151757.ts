...
export class PsySessionsComponent implements OnInit {
  ...
  addSession(dta) {
    ...
    this.model6.behavior=dta.behavior,
    this.model6.cognitive=dta.Cognitive,
    this.model6.cognitive_behavioral=dta.cog_beh,
    this.model6.humanistic=dta.Humanistic,
    this.model6.referred=dta.Feedback,
    this.model6.consent=dta.Clinician,
