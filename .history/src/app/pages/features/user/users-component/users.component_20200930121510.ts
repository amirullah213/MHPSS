...
export class UsersComponent implements OnInit {
  ...
  setTab(tab: string) {
    this.tab = tab;
     if(tab='newPats'){ this.userData.status=0; this.getUsers(this.userData) };
     if(tab='penPats'){ this.userData.status=1;this.getUsers(this.userData)};
    if(tab='seenPats'){this.userData.status=2;this.getUsers(this.userData)};
  }
